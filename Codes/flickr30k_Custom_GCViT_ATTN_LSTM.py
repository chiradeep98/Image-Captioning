# -*- coding: utf-8 -*-
"""F30k_Custom_GCVIT_ATT_LSTM_Latest_Ch1 (3).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16sneRZj89MmlBusyGP6K-3Pr4arPM6wb
"""
...
# # Build Model
# vit_feature_extractor = GCViT(**config)
# inp = ops.array(np.random.uniform(size=(1, 224, 224, 3)))
# out = vit_feature_extractor(inp)

# Load Weights
# ckpt_path = keras.utils.get_file(ckpt_link.split("/")[-1], ckpt_link)
# vit_feature_extractor.load_weights(ckpt_path)

# # Summary
# vit_feature_extractor.summary((224, 224, 3))
