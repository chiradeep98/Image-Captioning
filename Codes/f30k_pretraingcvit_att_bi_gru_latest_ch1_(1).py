# -*- coding: utf-8 -*-
"""F30k_PreTrainGCVIT_ATT_Bi_GRU_Latest_Ch1_(1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EgVFGl7TasWePxDZKvK1srK5WJWtRL56
"""
...
class Decoder(Model):
    def __init__(self, embed_dim, units, vocab_size):
        ...
        self.gru = Bidirectional(GRU(self.units//2,return_sequences=True,return_state=True,recurrent_initializer='glorot_uniform')) # building bi-directional GRU
        # self.bi_gru = tf.keras.layers.GRU(self.units,return_sequences=True,return_state=True,recurrent_initializer='glorot_uniform')
    ...
    def call(self,x,features, hidden):
        ...
        output,forward_state, backward_state = self.gru(embed) # Extract the output & hidden state from GRU layer. Output shape : (batch_size, max_length, hidden_size)
